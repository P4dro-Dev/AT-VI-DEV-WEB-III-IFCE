...
```
➕ Adicionar Tarefa	Registra uma nova tarefa no Firestore
🔁 Atualizar Status	Marca como concluída ou desfaz
🗑 Excluir Tarefa	Remove permanentemente no Firestore
